                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{url('boot/assets/images/downloadfile-3.jpg')}}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{url('boot/assets/imagesdownloadfile-3/.jpg')}}" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{url('boot/assets/images/downloadfile-3.jpg')}}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{url('boot/assets/images/downloadfile-3.jpg')}}" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                        ...
                        <div class="main_brand text-center">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="{{url('boot/assets/images/langfr-225px-Flag_of_Mali.svg.png')}}" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                            ...
                            <div class="col-md-3">
                                <div class="widget_item widget_latest sm-m-top-50">
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="{{url('boot/assets/images/ltst-img-1.jpg')}}" alt="" /></div>
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="{{url('boot/assets/images/ltst-img-2.jpg')}}" alt="" /></div>
                                        <div class="widget_latst_item_text">
                                            <p>Lorem ipsum dolor sit amet, consectetur</p>
                                            <a href="">21<sup>th</sup> July 2016</a>
                                        </div>
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="{{url('boot/assets/images/ltst-img-3.jpg')}}" alt="" /></div>
                                        <div class="widget_latst_item_text">
                                            <p>Lorem ipsum dolor sit amet, consectetur</p>
                                            <a href="">21<sup>th</sup> July 2016</a>
                                        </div>
