...
@endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="photo_ancienne_carte" value="" name="photo_ancienne_carte" />
                                            @if($errors->first('photo_ancienne_carte'))
<div class="alert-danger">Le champ photo_ancienne_carte est obligatoire</div>
@endif
                                        </div>
                                        <div class="form-group">
...
@endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" placeholder="date-renouvellement *" name="date_renouvellement" />
                                            @if($errors->first('date_renouvellement'))
<div class="alert-danger">Le champ  est obligatoire</div>
@endif
                                        </div>
